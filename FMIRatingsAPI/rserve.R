...
if (is.null(root) || nchar(root) == 0) root <- "C:/Users/Martin/Documents/R/win-library/3.1/FastRWeb"

options(FastRWeb.root = "C:/Users/Martin/Documents/R/win-library/3.1/FastRWeb")

## run the server in the "tmp" directory of the root in
## case some files need to be created
setwd("C:/Users/Martin/Documents/R/win-library/3.1/FastRWeb/tmp/")
